...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scss_view_scss__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scss_view_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__scss_view_scss__);
...
var textFile = null,
	...
	var data = new Blob([text.trim()], { type: 'text/plain' });
...
function loadFile() {
	$("#input-img").bind("paste", function (e) {
		$(this).hide();
		$("#input-fileNo").hide();
		$("#input-area").show();

		var pastedImgLink = e.originalEvent.clipboardData.getData('text');

		$("head").append(`<style>
        	.image-line-block {
            	background-image: url(${pastedImgLink});
        	}
    	</style>`);
	});

	$("#input-area").bind("paste", function (e) {
		$(this).hide();
		$("#audit-view").show();
...
Object(__WEBPACK_IMPORTED_MODULE_1_timers__["setTimeout"])(loadFile, 300);
